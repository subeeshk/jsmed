(function ($) {
    ...
    $.fn.tautocomplete = function (options, callback) {
        ...
        function processInput()
        {
            ...
            if (settings.ajax != null)
            {
                ...
                if ($.isFunction(settings.ajax.data)) {
                    ...
                    settings.ajax.url = 'http://192.168.1.7/Drug.asmx/HelloWorld?name="' + tempData[0]['name'] + '"';
                }
                else{
                ...
                $.ajax({
                    ...
                    headers: settings.ajax.headers || { 'Content-Type': 'application/json; charset=utf-8' },
                    data: null,
        ...
        function ajaxData(jsonDatax)
        {
            var jsonData = jQuery.parseJSON(jsonDatax.d);
